...
/**
  ...
  /*** end: section (1 of 2) of code duplicated
   * from In to StdIn. */
  /**
   * scanner object.
   */
  ...
  /**
    ...
    *
    * @return {@code true} if standard input is
    * empty (except possibly
  ...
  /**
    ...
    * excluding the line separator if present.
    *
  ...
  /**
    * Reads the next token from standard
    * input, parses it as an integer, and returns the integer.
    *
    * @return the next integer on standard input
    * @throws NoSuchElementException if standard input is empty
    * @throws InputMismatchException if
    * the next token cannot be parsed as an {@code int}
    */
  ...
  /**
    * Reads the next token from standard
    * input, parses it as a double, and returns the double.
    *
  ...
  /**
    * Reads the next token from standard
    * input, parses it as a float, and returns the float.
    *
  ...
  /**
    * Reads the next token from standard
    * input, parses it as a long integer, and returns the long integer.
    *
    * @return the next long integer on standard input
    * @throws NoSuchElementException if standard input is empty
    * @throws InputMismatchException if
    * the next token cannot be parsed as a {@code long}
    */
  ...
  /**
   * Reads all remaining tokens from standar
  ...
  /**
   * Reads all remaining lines from standard
   * input and returns them as an array of strings.
  ...
  /**
   * Reads all remaining tokens from standard
   * input, parses them as integers, and returns
   * them as an array of integers.
   * @return all remaining integers on standard input, as an array
   * @throws InputMismatchException if any
  ...
  /**
   * Reads all remaining tokens from standard
   * input, parses them as longs, and returns
   * them as an array of longs.
   * @return all remaining longs on standard input, as an array
   * @throws InputMismatchException if any
   * token cannot be parsed as a {@code long}
   */
  ...
  /**
   * Reads all remaining tokens from standard
   * input, parses them as doubles, and returns
